...
--
-- Host: 172.22.0.17    Database: kamailio
-- ------------------------------------------------------
...
CREATE DATABASE /*!32312 IF NOT EXISTS*/ `kamailio` /*!40100 DEFAULT CHARACTER SET cp1256 */ /*!80016 DEFAULT ENCRYPTION='N' */;
...
) ENGINE=InnoDB AUTO_INCREMENT=29 DEFAULT CHARSET=cp1256;
/*!40101 SET character_set_client = @saved_cs_client */;
...
(23,'uloc-66bbc37d-11b-8','websip',NULL,'sip:jugjfa88@11ocam4lp5ma.invalid;transport=ws','sip:192.168.174.130:46428;transport=ws',NULL,'2024-08-13 21:23:22',-1.00,'q8t61ugg4fbnahv5greilj',2,'2024-08-13 21:13:22',0,64,'JsSIP 3.1.2','tls:172.22.0.140:4443',6943,'<urn:uuid:8b495f56-d023-403a-a73b-642390533be0>',1,0,38,1,22),
(24,'uloc-66bbc37d-11c-e','abdo',NULL,'sip:qfb09qtc@o8ds1dipiem5.invalid;transport=ws','sip:192.168.174.1:63292;transport=ws',NULL,'2024-08-13 21:23:48',-1.00,'2883v99d69bhvdhbbrfhns',2,'2024-08-13 21:13:48',0,64,'JsSIP 3.1.2','tls:172.22.0.140:4443',6943,'<urn:uuid:d3ad7bef-9fd9-46f8-b127-4f4dd98cf6a8>',1,0,40,1,23),
(25,'uloc-66bbc37d-11b-a','websip',NULL,'sip:msee8grk@n02oel8avjvi.invalid;transport=ws','sip:192.168.174.130:58802;transport=ws',NULL,'2024-08-13 21:26:00',-1.00,'d9h58fi3ajnjssp8dqka67',4,'2024-08-13 21:16:00',0,64,'JsSIP 3.1.2','tls:172.22.0.140:4443',6943,'<urn:uuid:48e8dd4b-b631-475b-9a84-5de7f1f0ebcb>',1,0,2,1,24),
(26,'uloc-66bbc37d-11b-c','abdo',NULL,'sip:lo0m2v5s@1vorlnh1mt22.invalid;transport=ws','sip:192.168.174.1:63308;transport=ws',NULL,'2024-08-13 21:26:00',-1.00,'niv9bvl3gum721hqrbk4l7',4,'2024-08-13 21:16:00',0,64,'JsSIP 3.1.2','tls:172.22.0.140:4443',6943,'<urn:uuid:06853007-1d80-467e-b136-6f29165923e2>',1,0,4,1,25),
(27,'uloc-66bbcd10-13c-4','websip',NULL,'sip:gnk6up9h@7r7gb1l8j4mq.invalid;transport=ws','sip:192.168.174.130:37008;transport=ws',NULL,'2024-08-13 21:26:07',-1.00,'5ocnp1j9fiavk15fcl2ra4',2,'2024-08-13 21:16:07',0,64,'JsSIP 3.1.2','tls:172.22.0.140:4443',6943,'<urn:uuid:4cb89c5b-d9fd-483b-b4b0-30954a5e3c1c>',1,0,6,1,8),
(28,'uloc-66bbcd10-13b-2','abdo',NULL,'sip:tc3p70mo@rbqchigivuhl.invalid;transport=ws','sip:192.168.174.1:63316;transport=ws',NULL,'2024-08-13 21:26:12',-1.00,'ddupvrbbklo9b6h2743fbq',2,'2024-08-13 21:16:12',0,64,'JsSIP 3.1.2','tls:172.22.0.140:4443',6943,'<urn:uuid:a721e5cc-c7d0-48f3-b8d5-a241b42cc41d>',1,0,8,1,9);
...
(1,'abdo','172.22.0.140','king','1a64d624bc9f2ad12f217262c4863a3c','8e5dd5a8a35eab055bce760ce0258a31'),
(2,'websip','172.22.0.140','test','2858da983857eb5a8da1810a817bbddb','7c385487939adced31bd9a24a5e3be09');
...
) ENGINE=InnoDB AUTO_INCREMENT=71 DEFAULT CHARSET=cp1256;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2024-08-13 21:23:45
